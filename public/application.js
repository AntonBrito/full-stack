...
module.exports = {
  // host: 'https://wave-suave.herokuapp.com'
...
var providersHandlebars = function providersHandlebars(giveName, familyName, email, specialty) {
  var providerHandlebarsTemplate = __webpack_require__(18);
  var context = {
    'given_name': giveName,
  ...
  var providerTemplate = providerHandlebarsTemplate(context);
  $('#providers-div').append(providerTemplate);
};

// template context for appointments

var appointmentsHandlebars = function appointmentsHandlebars(name, lastname, email, date, providerId) {
  var appointmentHandlebarsTemplate = __webpack_require__(35);
  var context = {
    'name': name,
    'lastname': lastname,
    'email': email,
  ...
  var templateFilled = appointmentHandlebarsTemplate(context);
  $('#empty-appointments-div').append(templateFilled);
};

var dropdownHandlebars = function dropdownHandlebars(name, dataId) {
  var appointmentHandlebarsTemplate = __webpack_require__(36);
  var context = {
    'name': name
  };
  var templateFilled = appointmentHandlebarsTemplate(context);
...
module.exports = {
  providersHandlebars: providersHandlebars,
  appointmentsHandlebars: appointmentsHandlebars,
...
var onCreateAppointment = function onCreateAppointment(event) {
  ...
  event.preventDefault();
  api.createAppointment(data).then(ui.createAppointmentSuccess).catch(ui.createAppointmentFailure);
};
var onGetAppointments = function onGetAppointments(event) {
  console.log('onGetAppointments Succefull');
  event.preventDefault();
  api.getAppointments().then(ui.getAppointmentsSuccess).catch(ui.getAppointmentsFailure);
};

var onGetAllAppointments = function onGetAllAppointments(event) {
  console.log('onGetAllAppointments Succefull');
  event.preventDefault();
  api.getAllAppointments().then(ui.getAllAppointmentsSuccess).catch(ui.getAllAppointmentsFailure);
};
...
var onUpdateAppointment = function onUpdateAppointment(event) {
  ...
  event.preventDefault();
  api.updateAppointment(data, dataId).then(ui.updateAppointmentSuccess).catch(ui.updateAppointmentFailure);
};

var onUpdateAppointmentSaveId = function onUpdateAppointmentSaveId(event) {
  var dataId = this.getAttribute('data-id');
...
var onDeleteAppointment = function onDeleteAppointment(event) {
  ...
  event.preventDefault();
  api.deleteAppointment(data).then(ui.deleteAppointmentSuccess).catch(ui.deleteAppointmentFailure);
};
...
var onCreateProvider = function onCreateProvider(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.createprovider(data).then(ui.createProviderSuccess).catch(ui.createProviderFailure);
};

var onUpdateProvider = function onUpdateProvider(event) {
  var data = getFormFields(this);
  var dataId = this.getAttribute('data-id');
  console.log('onUpdateProvider dataId = ' + dataId);
  event.preventDefault();
  api.updateProvider(data, dataId).then(ui.editProviderSuccess).catch(ui.editProviderSuccessFailure);
};

var onUpdateProviderSaveId = function onUpdateProviderSaveId(event) {
  var dataId = this.getAttribute('data-id');
...
var onDeleteProvider = function onDeleteProvider(event) {
  var data = this.getAttribute('data');
  event.preventDefault();
  api.deleteProvider(data).then(ui.deleteProviderSuccess).catch(ui.deleteProviderFailure);
};

var onGetProvider = function onGetProvider(event) {
  console.log(app.user);
  event.preventDefault();
  api.getProvider().then(ui.getProviderSuccess).catch(ui.getProviderFailure);
};

var onGetAllProviders = function onGetAllProviders(event) {
  event.preventDefault();
  api.getAllProviders().then(ui.getAllProvidersSuccess).catch(ui.getAllProvidersFailure);
};
...
var onGetEvent = function onGetEvent(event) {
  console.log(app.user);
  event.preventDefault();
  api.getProvider().then(ui.getEventSuccess).catch(ui.getEventFailure);
};
...
module.exports = {
  ...
  onUpdateAppointmentSaveId: onUpdateAppointmentSaveId,
  onDeleteAppointment: onDeleteAppointment,
  onGetHistory: onGetHistory,
  onCreateProvider: onCreateProvider,
  onGetProvider: onGetProvider,
  onUpdateProvider: onUpdateProvider,
  onGetAllProviders: onGetAllProviders,
  onDeleteProvider: onDeleteProvider,
  onCreateEvent: onCreateEvent,
  onGetEvent: onGetEvent,
  onDeleteEvent: onDeleteEvent,
  onUpdateProviderSaveId: onUpdateProviderSaveId
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var updateAppointment = function updateAppointment(data, datId) {
  return $.ajax({
...
var getMyAppointments = function getMyAppointments(data) {
  console.log('Here is the Appointment' + app.user);
  return $.ajax({
    url: config.apiOrigin + '/appointments/',
    method: 'GET',
...
var getAllAppointments = function getAllAppointments() {
  return $.ajax({
    url: config.apiOrigin + '/appointments',
    method: 'GET'
  });
...
var deleteAppointment = function deleteAppointment(dataId) {
  return $.ajax({
...
var createProvider = function createProvider(data) {
  console.log(data);
  return $.ajax({
...
var updateProvider = function updateProvider(data) {
  console.log(data);
  return $.ajax({
    url: config.apiOrigin + '/providers',
    method: 'PATCH',
...
var deleteProvider = function deleteProvider(data) {
  return $.ajax({
...
var getAllProviders = function getAllProviders() {
  return $.ajax({
    url: config.apiOrigin + '/providers/',
    method: 'GET',
    headers: {
...
var getProvider = function getProvider(dataId) {
...
var getEvent = function getEvent(dataId) {
  console.log('api.js dataId =' + dataId);
  return $.ajax({
...
var deleteEvent = function deleteEvent(dataId) {
  return $.ajax({
    url: config.apiOrigin + '/events/' + dataId,
    method: 'DELETE',
    headers: {
...
var createAppointmentSuccess = function createAppointmentSuccess(data) {
...
var createAppointmentFailure = function createAppointmentFailure(error) {
  console.log(error);
  console.log('Failed');
};
...
var updateAppointmentSuccess = function updateAppointmentSuccess(data) {
  ...
  var name = data.appointments.name;
  var lastname = data.appointments.lastname.email;
  var date = data.appointments.date;
  var email = data.appointments.email;
  var providerId = data.appointments.provider_id;
  console.log('name + lastname + email + provider_id');
  template.AppointmentsHandlebars(name, lastname, email, date, providerId);
};

var getMyAppointmentsSuccess = function getMyAppointmentsSuccess(data) {
...
var getAllAppointmentsSuccess = function getAllAppointmentsSuccess(data) {
  ...
  // $('#empty-appointments-div').show()
  for (var i = 0; i < data.appointments.length; i++) {
    var name = data.appointments[i].name;
    var lastname = data.appointments[i].lastname;
    var email = data.appointments[i].email;
    var providerId = data.appointments[i].provider_id;
    console.log('name + lastname + email + provider_id');
    template.AppointmentsHandlebars(name, lastname, email, providerId);
  }
};

var getMyAppointmentsFailure = function getMyAppointmentsFailure(error) {
  console.log(error);
  console.log('Failed in getAllMyAppointmentsFailure');
};

var getAllMyAppointmentsSuccess = function getAllMyAppointmentsSuccess(data) {
  ...
  for (var i = 0; i < data.appointments.length; i++) {
    ...
    var lastname = data.appointments[i].lastname;
    var email = data.appointments[i].email;
    var date = data.appointments[i].rate;
    var providerId = data.appointments[i].provider_id;
    template.appointmentsHandlebars(name, lastname, email, date, providerId);
  }
};

var getAllMyAppointmentsFailure = function getAllMyAppointmentsFailure(error) {
  console.log(error);
  console.log('Failed in getAllMyAppointmentsFailure');
};

var getAppointmentsFailure = function getAppointmentsFailure(error) {
  console.log(error);
...
var getAppointmentsSuccess = function getAppointmentsSuccess(data) {
  ...
  $('#Appointments-div').empty();
  for (var i = 0; i < data.appointments.length; i++) {
    var name = data.appointment[i].name;
    var lastname = data.appointments[i].lastname;
    var email = data.appointments[i].email;
    var providerId = data.appointments[i].provider_id;
    console.log('name + lastname + email + provider_id');
...
var updateAppointmentFailure = function updateAppointmentFailure(error) {
  console.log(error);
...
var deleteAppointmentFailure = function deleteAppointmentFailure(error) {
  console.log(error);
  console.log('Failed in delete Appointment Failure');
};

var createProviderSuccess = function createProviderSuccess(data) {
  console.log(data);
  console.log('Succeded in create Provider Success');
  $('textarea').val('');
};

var createProviderFailure = function createProviderFailure(error) {
  console.log(error);
  console.log('Failed in create Provider Failure');
};

var deleteProviderSuccess = function deleteProviderSuccess(data) {
  console.log(data);
  console.log('Succeded in delete Provider Success');
  $('#provider-div').empty();
};

var deleteProviderFailure = function deleteProviderFailure(error) {
  console.log(error);
  console.log('Failed in delete Provider Failure');
};

var updateProviderSuccess = function updateProviderSuccess(data) {
  console.log(data);
  console.log('Succeded in updateProviderSuccess');
  $('#providers-div').empty();
  for (var i = 0; i < data.provider.length; i++) {
    var name = data.provider[i].given_name;
    var lastname = data.provider[i].family_name;
    var email = data.provider.email;
    var specialty = data.provider.specialty;
    template.providersHandlebars(name, lastname, email, specialty);
  }
};

var updateProviderFailure = function updateProviderFailure(error) {
  console.log(error);
  console.log('Failed in deleteproviderFailure');
};

var getProviderSuccess = function getProviderSuccess(data) {
  console.log(data);
  console.log('Successfully retrieved all MY provider');
  $('#providers-div').empty();
  $('#empty-appointments-div').show();
  for (var i = 0; i < data.providers.length; i++) {
    var name = data.providers[i].given_name;
    var lastname = data.providers[i].family_name;
    var email = data.providers[i].email;
    var specialty = data.providers[i].specialty;
    template.providersHandlebars(name, lastname, email, specialty);
  }
};
var getProviderFailure = function getProviderFailure(error) {
  console.log('Failed');
  $('#providers-div').html('These Are Not The providers You Are Looking For');
  console.log(error);
};

var getAllProviderSuccess = function getAllProviderSuccess(data) {
  console.log(data);
  console.log('Successfully retrieved all MY provider');
  $('#providers-div').empty();
  $('#empty-appointments-div').show();
...
var getAllProviderFailure = function getAllProviderFailure(err) {
  console.log(err);
...
var getEventSuccess = function getEventSuccess(data) {
  ...
  for (var i = 0; i < data.events.length; i++) {
    var name = data.pevents[i].name;
    var startDate = data.events[i].start_date;
    var endDate = data.events[i].end_date;
    var info = data.events[i].info;
    template.eventsHandlebars(name, startDate, endDate, info);
  }
};

var getEventFailure = function getEventFailure(err) {
  console.log(err);
  console.log('Failed retieving all provider by all users');
...
var updateEventsSuccess = function updateEventsSuccess(data) {
  console.log(data);
  console.log('Succeded in updateEventSuccess');
  $('#event-div').empty();
  for (var i = 0; i < data.events.length; i++) {
    var name = data.events[i].name;
    var startDate = data.events[i].start_ate;
    var endDate = data.events[i].end_date;
    var info = data.events[i].info;
    template.eventsHandlebars(name, startDate, endDate, info);
  }
...
var updateEventFailure = function updateEventFailure(error) {
  console.log(error);
...
module.exports = {
  ...
  createAppointmentFailure: createAppointmentFailure,
  getAppointmentsSuccess: getAppointmentsSuccess,
  getAllAppointmentsSuccess: getAllAppointmentsSuccess,
  getMyAppointmentsFailure: getMyAppointmentsFailure,
  getMyAppointmentsSuccess: getMyAppointmentsSuccess,
  getAllProviderSuccess: getAllProviderSuccess,
  getAppointmentsFailure: getAppointmentsFailure,
  getAllProviderFailure: getAllProviderFailure,
  getAllMyAppointmentsFailure: getAllMyAppointmentsFailure,
  getAllMyAppointmentsSuccess: getAllMyAppointmentsSuccess,
  // getEventsFailure,
  getHistorySuccess: getHistorySuccess,
  getHistoryFailure: getHistoryFailure,
  createProviderSuccess: createProviderSuccess,
  createProviderFailure: createProviderFailure,
  createEventFailure: createEventFailure,
  createEventSuccess: createEventSuccess,
  getProviderSuccess: getProviderSuccess,
  getProviderFailure: getProviderFailure,
  getEventFailure: getEventFailure,
  getEventSuccess: getEventSuccess,
  deleteProviderSuccess: deleteProviderSuccess,
  deleteProviderFailure: deleteProviderFailure,
  deleteAppointmentSuccess: deleteAppointmentSuccess,
  deleteAppointmentFailure: deleteAppointmentFailure,
  ...
  updateProviderSuccess: updateProviderSuccess,
  updateProviderFailure: updateProviderFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"providers-div\" data-id=\""
    ...
    + "</p>\n    <p>"
    + alias4(((helper = (helper = helpers.specialty || (depth0 != null ? depth0.specialty : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"specialty","hash":{},"data":data}) : helper)))
    + "</p>\n    <button type=\"button\" class=\"providerEditButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\" name=\"editButton\">Edit</button>\n    <button type=\"button\" class=\"providersDeleteButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"appointments-div\" class=\"appointments-div\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\">\n  <td>"
    ...
    + "</td>\n  <td>"
    + alias4(((helper = (helper = helpers.provider_id || (depth0 != null ? depth0.provider_id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"provider_id","hash":{},"data":data}) : helper)))
    + "</td>\n  <button type=\"button\" class=\"appointmentEditButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\" name=\"editButton\">Edit</button>\n  <button type=\"button\" class=\"appointmentDeleteButton\" data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\" name=\"deleteButton\">Delete</button>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"Appointments-dropdown-Appointment-list\">\n  <p id='Appointments-dropdown-Appointment-name' data-id=\""
    + alias4(((helper = (helper = helpers.dataId || (depth0 != null ? depth0.dataId : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dataId","hash":{},"data":data}) : helper)))
    + "\">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</p>\n</div>\n";
...
//
//
// const makeAppointment = function () {
//
// }
// // TODO create Appointment
// // TODO make that after sign in we can make Appointment
// // TODO make
